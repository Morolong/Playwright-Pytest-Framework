...
class RequestLoanPage: 
    ...
    def __init__(self, page: Page):
        ...
        self.processed_heading = page.get_by_role("heading", name="Loan Request Processed")
        self.congrats_message = page.get_by_text("Congratulations, your loan")
 
        self.account_details_heading = page.get_by_role("heading", name="Account Details")
    ...
    def fill_down_payment(self, down_payment: str):
        self.down_payment_input.click()
    ...
    def apply_for_loan(self, amount: str = "", down_payment: str = ""):
    ...
    def loan_result_row(self, loan_provider: str, date_text: str, status_text: str = "Approved"):
        return {
            "provider": self.page.get_by_role("cell", name=loan_provider),
            "date": self.page.get_by_role("cell", name=date_text),
            "status": self.page.get_by_role("cell", name=status_text),
        }
    ...
    def expect_loan_approved(self, loan_provider: str, date_text: str):
        row = self.loan_result_row(loan_provider, date_text, "Approved")
    ...
    def expect_account_details(self, account_number: str):
        ...
        expect(self.page.get_by_role("cell", name=account_number)).to_be_visible()
        expect(self.page.get_by_role("cell", name="LOAN")).to_be_visible()
